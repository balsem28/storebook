...
namespace storebook.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(storebookContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.usersaccounts != null ?
                        ...
                        Problem("Entity set 'storebookContext.usersaccounts'  is null.");
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\balse\\OneDrive\\Documents\\mynewdb.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
