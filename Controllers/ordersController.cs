...
namespace storebook.Controllers
{
    public class ordersController : Controller
    {
        ...
        public ordersController(storebookContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.orders != null ? 
                          ...
                          Problem("Entity set 'storebookContext.orders'  is null.");
        }
        ...
        public async Task<IActionResult> Create(int bookId,int quantity)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\balse\\OneDrive\\Documents\\mynewdb.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
        ...
        public async Task<IActionResult> DeleteConfirmed(int? id)
        {
            ...
            {
                return Problem("Entity set 'storebookContext.orders'  is null.");
            }
            var orders = await _context.orders.FindAsync(id);
            if (orders != null)
            {
